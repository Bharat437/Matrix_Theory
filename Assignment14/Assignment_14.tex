...
\end{align}}&\\
\hline
3&From \eqref{p1}, \eqref{p2} and also we can say that column space $C(\vec{A})$ and null&\\&space $N(\vec{A})$ are r-dimensional space and n-dimensional space respectively&\\&which will intersect only at origin(zero vector).&\\&And also from \eqref{R} and \eqref{K}, we get&\\&\parbox{13cm}{\begin{align}
