...
\end{align}
Using section 3.1.22, Let \textbf{x} be an equidistant point from points \textbf{A} and \textbf{B}. Then we have
\begin{align}
    \abs{\abs{\textbf{x}-\myvec{3\\4}}}^2=\abs{\abs{\textbf{x}-\myvec{-1\\2}}}^2
\end{align}
\begin{multline}
    \implies \abs{\abs{\textbf{x}}}^2+\abs{\abs{\myvec{3\\4}}}^2-2\left(\begin{array}{cc}3 & 4\end{array}\right)\textbf{x} \\= \abs{\abs{\textbf{x}}}^2+\abs{\abs{\myvec{-1\\2}}}^2-2\left(\begin{array}{cc}-1 & 2\end{array}\right)\textbf{x}
\end{multline}
\begin{align}
    \left(\begin{array}{cc}2 & 1\end{array}\right)\textbf{x}=5
\end{align}
