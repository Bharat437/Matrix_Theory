...
Length of three sides are given as below:
\begin{align}
    \vec{AB}=\norm{\vec{A-B}}\\
    \vec{BC}=\norm{\vec{B-C}}\\
    \vec{AC}=\norm{\vec{A-C}}
...
\begin{align}
    \implies\vec{AB}=\vec{BC}=\vec{AC}=k
\end{align}

Let $\vec{B}$ be origin. Then $\vec{A}=\myvec{ \frac{k}{2} \\ \frac{\sqrt{3}k}{2}}$ and $\vec{C}=\myvec{k \\ 0}$.
...
\begin{align}
    ...
    \implies \cos{\theta}=\frac{\myvec{ \frac{k}{2} \\ \frac{\sqrt{3}k}{2}}^T\myvec{k \\ 0}}{k^2}\\
    \implies \cos{\theta}=\frac{\frac{k^2}{2}}{k^2}\\
    \implies \cos{\theta}=\frac{1}{2}
\end{align}

In equilateral triangle, $\angle ABC=60^\circ$
\begin{align}
