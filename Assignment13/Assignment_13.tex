...
\hline
2.&From Table \ref{obs}, we got $\vec{W}$ contains the vectors which are all linear &\\&combination of basis vector $\vec{b}$ as shown in \eqref{Wkb} \eqref{basis}.&\\&Therefore,&False\\&\parbox{13cm}{\begin{align}
    \vec{W}\neq\cbrak{(0,0)}
\end{align}}&\\
\hline
