...
\hline
2.&From Table \ref{obs}, we got $\vec{W}$ consists points which have same x and y &\\&coordinates.&\\&For example vector $\vec{u}=\myvec{1\\1}\in\mathbb{R}^2$, we will calculate $\vec{B}(\vec{v_0},\vec{u})$&\\&\parbox{13cm}{\begin{align}
